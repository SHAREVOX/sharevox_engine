...
build-linux-docker-ubuntu20.04:
	docker buildx build . \
		...
		--build-arg ONNXRUNTIME_URL=https://github.com/microsoft/onnxruntime/releases/download/v1.12.1/onnxruntime-linux-x64-1.12.1.tgz \
...
build-linux-docker-nvidia-ubuntu20.04:
	docker buildx build . \
		...
		--build-arg ONNXRUNTIME_URL=https://github.com/microsoft/onnxruntime/releases/download/v1.12.1/onnxruntime-linux-x64-gpu-1.12.1.tgz \
